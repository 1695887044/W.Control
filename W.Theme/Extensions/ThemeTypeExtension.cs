...
using W.Themes.FontSizes;
using W.Themes.Layouts;

namespace W.Themes.Extensions;
...
public static class ThemeTypeExtension
{
    ...
    private const string Format1 = "pack://application:,,,/W.Theme;component/{0}.xaml";
    private const string Format2 = "pack://application:,,,/W.Theme;component/{0}/{1}.xaml";
    private const string Format3 = "pack://application:,,,/W.Theme;component/{0}/{1}/{2}.xaml";
